...
bibliography: That-s-a-BigAss-Chicken.bib
floatsintext: true
documentmode: man
...
# Where we will load all of the necessary libraries etc.

```

> *If you've ever seen a picture of Eddy the Chicken, your first words would invariably be "That's a Big-Ass Chicken!" And you would be correct. See Figure 1 for reference.*

```{r}
#![Eddy the Chicken](sampleimage.png){
  #fig-myimportedimage 
 # width="5in" 
