...
> *If you've ever seen a picture of Edgar the Chicken, your first words would invariably be "That's a Big-Ass Chicken!" And you would be correct. See Figure 1 for reference.*

```{r, echo=FALSE}
#![Edgar the Chicken](orpignton hen(edgar).jpg){
  #fig-myimportedimage 
 # width="5in" 
