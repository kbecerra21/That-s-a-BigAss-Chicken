...
# Chicken data
The data for this paper can be found in the folder Data_BigAssChicekn : The the file contains the original data file Chickweight.csv. The original ChickWeight.csv data file can be found here  https://www.kaggle.com/datasets/lsind18/weight-vs-age-of-chicks-on-different-diets/data
